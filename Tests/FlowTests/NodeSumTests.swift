...
final class NodeSumTests: XCTestCase {
    ...
    func testNodeSumBool() throws {
        let n0 = Node.sum(type: .bool(), id: "", title: "")
        do {
    ...
    func testNodeSumInt() throws {
        let n0 = Node.sum(type: .int(), id: "", title: "")
        do {
    ...
    func testNodeSumFloat() throws {
        let n0 = Node.sum(type: .float(), id: "", title: "")
        do {
    ...
    func testNodeSumString() throws {
        let n0 = Node.sum(type: .string(), id: "", title: "")
        do {
    ...
    func testNodeSumBoolArray() throws {
        let n0 = Node.sum(type: .boolArray(), id: "", title: "")
        do {
    ...
    func testNodeSumIntArray() throws {
        let n0 = Node.sum(type: .intArray(), id: "", title: "")
        do {
    ...
    func testNodeSumFloatArray() throws {
        let n0 = Node.sum(type: .floatArray(), id: "", title: "")
        do {
    ...
    func testNodeSumStringArray() throws {
        let n0 = Node.sum(type: .stringArray(), id: "", title: "")
        do {
