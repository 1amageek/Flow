...
final class NodeProductTests: XCTestCase {
    ...
    func testNodeProductBool() throws {
        let n0 = Node.product(type: .bool(), id: "", title: "")
        do {
    ...
    func testNodeProductInt() throws {
        let n0 = Node.product(type: .int(), id: "", title: "")
        do {
    ...
    func testNodeProductFloat() throws {
        let n0 = Node.product(type: .float(), id: "", title: "")
        do {
    ...
    func testNodeProductString() throws {
        let n0 = Node.product(type: .string(), id: "", title: "")
        do {
    ...
    func testNodeProductBoolArray() throws {
        let n0 = Node.product(type: .boolArray(), id: "", title: "")
        do {
    ...
    func testNodeProductIntArray() throws {
        let n0 = Node.product(type: .intArray(), id: "", title: "")
        do {
    ...
    func testNodeProductFloatArray() throws {
        let n0 = Node.product(type: .floatArray(), id: "", title: "")
        do {
    ...
    func testNodeProductStringArray() throws {
        let n0 = Node.product(type: .stringArray(), id: "", title: "")
        do {
