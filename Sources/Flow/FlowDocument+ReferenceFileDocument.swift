...
//
//    @Published public var seletedGraphID: Graph.ID?
//
...
//
//    public init() {
//        let graph: Graph = Graph(id: UUID().uuidString, nodes: [], edges: [])
//        self.flow = Flow(graphs: [graph])
//        self._seletedGraphID = Published(initialValue: graph.id)
//    }
//
//    // MARK: - ReferenceFileDocument
//
...
//
//    struct Delegate {
//        var callableFunctions: CallableFunctions!
//        var shouldConnectNodeHandler: ((_ nodes: [Node], _ edges: [Edge], _ connection: Connection) -> Bool)!
//    }
//
//    func shouldConnect( _ connection: Connection) -> Bool { self.delegate.shouldConnectNodeHandler(self.nodes, self.edges, connection) }
//}
//
...
//
//    var graph: Graph? {
//        guard let id = seletedGraphID else { return nil }
//        return flow.graphs[id]
//    }
//
...
//                }
//                guard let callable = self.delegate.callableFunctions[typeID] else {
//                    fatalError()
//                }
